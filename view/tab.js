...
import ModalExample from './slide';
import TabBar from 'react-native-xtabbar';
import AndroidSlide from './androidSlide';
...
export default class Home extends Component {
    ...
    //             </TabBarIOS.Item>
    //             <TabBarIOS.Item
    //                 icon={require('../img/tab_icon_nor_mine.png')}
    //                 selectedIcon={require('../img/tab_icon_cli_mine.png')}
    //                 renderAsOriginal
    //                 title="More"
    ...
    render() {
        return (
            <TabBar onItemSelected={(index) => {
                ...
                <TabBar.Item icon={require('../img/tab_icon_nor_mine.png')}
                             selectedIcon={require('../img/tab_icon_cli_mine.png')}
                             title="Home">
                    <MyScene2 />
                </TabBar.Item>
